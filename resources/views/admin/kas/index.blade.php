<x-app-layout>
    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl space-y-6 px-4 sm:px-6 lg:px-8">
            ...
            {{-- TAB NAVIGATION --}}
            <div class="flex flex-wrap gap-2 rounded-2xl border border-slate-200 bg-white p-1.5 shadow-sm w-full sm:w-fit overflow-x-auto">
            ...
            @if($tab === 'rekap')
                <form action="{{ route('admin.kas.index') }}" method="GET"
                    ...
                    <a href="{{ route('admin.kas.export.pdf', ['bulan' => $bulanDipilih, 'tahun' => $tahunDipilih]) }}"
                       target="_blank"
                       class="inline-flex items-center gap-2 rounded-xl bg-emerald-600 px-5 py-2.5 text-sm font-bold text-white transition hover:bg-emerald-700">
